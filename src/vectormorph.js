...
import { CSS3DRenderer, CSS3DSprite } from "three-css3d";
...
export function init() {
	...
	image.addEventListener("load", function () {
		for (let i = 0; i < ballsNr; i++) {
			...
			(object.position.x = Math.random() * 3500), (object.position.y = Math.random() * 3500), (object.position.z = Math.random() * 3500);
			scene.add(object);
...
function insertSphere() {
	...
	for (let i = 0; i < ballsNr; i++) {
		...
		posArray.push(radius * Math.cos(theta) * Math.sin(phi), radius * Math.sin(theta) * Math.sin(phi), radius * Math.cos(phi));
	}
}
...
function insertBowtie() {
	...
	for (let i = 0; i < ballsNr; i++) {
		...
		posArray.push(radius * Math.cos(theta) * Math.sin(phi), radius * Math.sin(theta) * Math.cos(phi), radius * Math.cos(phi));
	}
}
...
function insertBowtie2() {
	...
	for (let i = 0; i < ballsNr; i++) {
		...
		posArray.push(radius * Math.cos(theta) * Math.cos(phi), radius * Math.sin(theta) * Math.sin(phi), radius * Math.cos(phi));
	}
}
...
function insertSaddle() {
	...
	for (let i = 0; i < ballsNr; i++) {
		...
		posArray.push(radius * Math.cos(theta) * Math.sin(phi), radius * Math.cos(theta) * Math.cos(phi), radius * Math.cos(phi));
	}
}
...
function insertSpiral() {
	...
	for (let i = 0; i < ballsNr; i++) {
		...
		posArray.push(radius * Math.cos(theta) * Math.sin(phi), radius * Math.sin(theta) * Math.sin(phi), radius * Math.tan(phi));
	}
}
...
function insertRandom() {
	for (let i = 0; i < ballsNr; i++) {
		posArray.push(Math.random() * 3500 - 2000, Math.random() * 3500 - 2000, Math.random() * 3500 - 2000);
	}
}
